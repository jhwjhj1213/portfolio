...
class PA3Library {
    ...
    */
     ...
     *  from the given file.                                                                                takes in whole file, splits them into row, parses, stores, and returns DataPoint objects through parseLine
     */
    ...
    */
    private DataPoint parseLine(String csvRow)
    {
        ...
        int[] cByRace = new int[lineData.length - 3];    // 3 of the columns are dealing with other data
        int count = 0;
        ...
        return new DataPoint(date, state, totalCases, cByRace);  // cbyrace is an array of integers
    }
}
